...
- (void)viewDidLoad
{
    ...
    NSURL *videoUrl = [NSURL URLWithString:@"http://127.0.0.1:8080/encrypted.m3u8"];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(playerLog:) name:AVPlayerItemNewErrorLogEntryNotification object:_playerItem];
}
...
- (void)playerLog:(NSNotification *)noti
{
    NSLog(@">>>>%@",[[noti object] error]);
}
